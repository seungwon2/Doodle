...
export default function Mypage() {
  ...
  return (
      <Wrapper>
          ...
          <Input placeholder="이름" name="name" value={form.name} name="name" onChange={handleFormChange} />
          </Row>
          <Row>
          <NormalText text="연락처"/>
          <Input placeholder="'-' 빼고 입력" name="phoneNum" value={form.phoneNum} name="phoneNum" onChange={handleFormChange} />
          </Row>
          <ButtonRow>
